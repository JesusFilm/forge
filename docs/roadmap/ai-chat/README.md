...
| [feat-207](feat-207-chat-auth.md)                            | Chat app authentication                                            | jian wei | P1       | 2026-07-07 | 5    | 🟡 in-progress | #1438   |
...
| [feat-229](feat-229-chat-auth-register-oauth-client.md)      | Register chat OAuth client in apps/auth (chat auth enablement)     | jian wei | P1       | 2026-07-09 | 2    | 🟡 in-progress | —       |
| [feat-231](feat-231-chat-auth-prod-oauth-client.md)          | Register chat deployed-environment OAuth clients (prod enablement) | jian wei | P2       | 2026-07-20 | 1    | 🔵 not-started | —       |
