...
feat-170's seeker agent ships with a stubbed `retrieveAnswer` tool: it returns
...
Requirements: `docs/brainstorms/2026-06-10-seeker-rag-connection-requirements.md`.
