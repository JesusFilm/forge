...
- Static Forge config from `feat-159`: `apps/web/src/lib/watch-home-carousel-config.ts`
- Resolver gap reporting from `feat-159`: `apps/web/src/lib/watch-home-carousel.ts`
