...
- Passed the 128-URL production-to-preview matrix with 125 exact matches, 3
  intentional accepted differences, 0 soft regressions, and 0 hard
  regressions.
- Passed focused and complete Web tests, typecheck, lint, production build, and
  real-browser English/Romanian contextual route verification.
