...
- `JESUS_FILM_CHAPTERS|JESUS_FILM_PASSAGES` in `apps/mastra/src/services/devotional`.
- `detect-and-trim-snippet|video-card` in `apps/shorts-worker`.
- `clipStartSec|clipLengthSec` in `apps/mastra/src/services/devotional`.
