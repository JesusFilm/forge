...
- `questions|prayer` in `apps/mastra/src/services/devotional/devotional-writer.ts`.
- `safety` in `apps/mastra/src/services/devotional/safety-gate.ts`.
- `outro|questions` in `packages/shorts-compositions/src/devotional`.
