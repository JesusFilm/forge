...
- `needsCanonicalSource` in `apps/mastra/src/services/devotional`.
- `API_BIBLE|SUBTITLE_VALIDATION_BIBLE` in `apps/mastra/src`.
- `scripture` in `packages/shorts-compositions/src/devotional`.
