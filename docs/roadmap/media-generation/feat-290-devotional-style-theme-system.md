...
- `warm-cinematic|sepia-film|noir-bw` in `packages/shorts-compositions`.
- `style|theme` in `apps/mastra/src/services/devotional`.
- `mood` in `packages/shorts-compositions/src/devotional`.
