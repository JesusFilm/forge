...
- `partnerDevotional|Cru` in `apps/mastra/src/services/devotional`.
- `reflection` in `apps/mastra/src/services/devotional/video-segments.ts`.
- `highlight|layout` in `packages/shorts-compositions/src/devotional`.
