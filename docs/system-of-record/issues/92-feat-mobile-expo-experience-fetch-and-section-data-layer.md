...
artifactType: issue
issueNumber: 92
issueTitle: "feat(mobile-expo): Experience fetch and section data layer"
issueUrl: "https://github.com/JesusFilm/forge/issues/92"
state: "CLOSED"
closedAt: "2026-03-04T00:29:06Z"
labels: []
linkedPrs:
  [
...
The Expo app needs a data layer that uses the GraphQL client (from the previous issue) to fetch watch home and experience-by-slug, and maps the API response to section models (MediaCollection, PromoBanner, InfoBlocks, CTA) for the UI layer.
...
- Parent: #89
- Depends on: #91
- [apps/web/src/lib/content.ts](apps/web/src/lib/content.ts) (getWatchExperience pattern)
- [apps/cms/schema.graphql](apps/cms/schema.graphql) (Experience, sections)
