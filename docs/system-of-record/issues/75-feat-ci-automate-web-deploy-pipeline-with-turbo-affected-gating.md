...
artifactType: issue
issueNumber: 75
issueTitle: "feat(ci): automate web deploy pipeline with turbo affected gating"
issueUrl: "https://github.com/JesusFilm/forge/issues/75"
state: "CLOSED"
...
Epic #68 needs branch-aware web deployments that avoid unnecessary runs. We need a CI design that supports PR previews and controlled stage/prod promotion using Turbo affected checks.
