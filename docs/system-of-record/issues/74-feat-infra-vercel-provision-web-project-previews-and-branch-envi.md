...
artifactType: issue
issueNumber: 74
issueTitle: "feat(infra-vercel): provision web project previews and branch environments"
issueUrl: "https://github.com/JesusFilm/forge/issues/74"
state: "CLOSED"
...
Epic #68 requires a Terraform-defined Vercel deployment topology supporting PR previews and branch promotion behavior for `stage` and `main`.
...
- `infra/vercel/variables.tf`
- `infra/vercel/outputs.tf`
