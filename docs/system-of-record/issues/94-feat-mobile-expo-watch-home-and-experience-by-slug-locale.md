...
artifactType: issue
issueNumber: 94
issueTitle: "feat(mobile-expo): Watch home and experience-by-slug + locale"
issueUrl: "https://github.com/JesusFilm/forge/issues/94"
state: "CLOSED"
closedAt: "2026-03-11T01:12:06Z"
labels: []
linkedPrs:
  [
...
The Expo app needs screens for the watch home (homepage experience) and for experience-by-slug (e.g. easter, christmas) with locale. Navigation and routing must wire the data layer and section renderers into these screens.

> **Note:** The section types have been updated to include all 10 active types (VideoHero, MediaCollection, CTA, Text, Video, BibleQuotesCarousel, RelatedQuestions, Card, Section, Container). PromoBanner and InfoBlocks are deprecated and not rendered.

## Expected outcome

- Watch home screen: fetches homepage experience for a locale and renders all section types via section renderers.
- Experience-by-slug screen: fetches experience by slug and locale; renders sections including nested Section/Container wrappers.
- Navigation/routing so users can open home and slug-based experiences (e.g. deep link or tab/stack).
- Locale supported (passed to data layer).

## Acceptance criteria

- [ ] Watch home screen implemented and shows section-based content for all 10 active section types.
- [ ] At least one experience-by-slug route (e.g. easter or christmas) with locale.
- [ ] Navigation between home and slug experiences (e.g. React Navigation or Expo Router).
- [ ] Nested Section and Container content renders correctly within experience screens.
- [ ] Loading and error states handled.

## Possible solution(s)

1. Expo Router or React Navigation; routes like `/` (home) and `/[slug]` or `/[slug]/[locale]`.
2. Data layer called from screen/hook; section list passed to SectionDispatcher loop.

## References

- Parent: #89
- Depends on: #93
- [apps/web/src/app/page.tsx](apps/web/src/app/page.tsx), [apps/web/src/app/[slug]/[locale]/page.tsx](apps/web/src/app/[slug]/[locale]/page.tsx)
- [jesusfilm.org/watch](https://www.jesusfilm.org/watch)
- [jesusfilm.org/watch/easter.html/english.html](https://www.jesusfilm.org/watch/easter.html/english.html) — visual reference
