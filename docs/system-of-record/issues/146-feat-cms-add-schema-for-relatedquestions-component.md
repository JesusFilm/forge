...
artifactType: issue
issueNumber: 146
issueTitle: "feat(cms): add schema for RelatedQuestions component"
issueUrl: "https://github.com/JesusFilm/forge/issues/146"
state: "CLOSED"
closedAt: "2026-03-05T01:28:18Z"
labels: ["cms", "feat"]
linkedPrs:
  [
...
Need a RelatedQuestions component schema so editors can configure a block of related Q&A or FAQ content in the CMS for use on the web (e.g. accordion or list).
...
- Related (web implementation): #156
