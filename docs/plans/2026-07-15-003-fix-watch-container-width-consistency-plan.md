...
- **A1 â€” Watch viewer:** navigates among home, videos, language discovery, history, and series pages on mobile through ultrawide displays.
- **A2 â€” Watch frontend maintainer:** needs one reusable layout contract that prevents route-local width drift.
...
### U1 â€” Lock the shared Watch frame contract
...
### U2 â€” Migrate narrower language and history page frames
...
### U3 â€” Cap series content sections at the shared frame
...
### U4 â€” Audit, browser-verify, and record performance evidence
...
- `/watch` â€” canonical home reference.
- A single-video route â€” canonical video reference.
- `/watch/languages` â€” formerly 112rem.
- A language inventory route such as `/watch/english.html/videos` â€” formerly `max-w-7xl`.
- `/watch/history` â€” formerly `max-w-5xl`.
- A series route â€” formerly uncapped metadata and episode sections.
