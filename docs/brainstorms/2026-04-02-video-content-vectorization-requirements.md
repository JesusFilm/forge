...
- **Three-language prototype (en/es/fr)**: Process English, Spanish, and French videos (~$10-$15 actual cost per R0 audit). Three languages are the minimum to prove locale-aware deduplication actually works — you can't verify "no locale bleed" with one language. Catalog is 955 processable videos (was estimated at 5K-10K). Phase 2 is a separate funding decision.
