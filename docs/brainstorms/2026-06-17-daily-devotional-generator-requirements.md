...
We want a daily, engaging, scripture-centered **devotional** that feels *current* —
...
1. **A hook** — a reason this devotional matters *today*. Priority order:
...
- **Scripture selection.** How is the daily passage chosen so it coheres with the
  hook *and* has a matchable video — does the hook drive the passage, or vice
  versa, day to day?
