...
}finally{await writeFile(base+'/preview-inspection.json',JSON.stringify({out,pageErrors:errors,applied:false,newGenerationRequests:0},null,2));await browser.close();}
