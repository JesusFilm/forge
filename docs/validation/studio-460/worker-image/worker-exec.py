...
if sys.argv[1]=='http':
 ...
 command=['nsenter',f'--user=/proc/{parent}/ns/user',str(b/'buildkit/bin/buildkit-runc'),'--root',str(b/'run/worker-runtime-runc'),'--rootless=true','exec','studio460-worker-image2','/usr/local/bin/node','--input-type=module','-e',code]
