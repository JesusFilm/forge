...
const child=spawn('/usr/bin/unshare',['-UrmpCf','--kill-child=KILL','/usr/bin/python3','/tmp/forge-studio-460-prep/pid1-rootfs.py',root+'/mounts.json'],{stdio:['ignore','inherit','inherit']});
