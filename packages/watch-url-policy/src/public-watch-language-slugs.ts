/**
 * Hand-maintained slug corpus mirroring the keys of Web's admin
 * Language.bcp47 snapshot (apps/web/src/lib/language-bcp47-map.ts), plus
 * public Watch URL overrides. Update this file alongside that one — see its
 * header for the current maintenance approach and feat-337 (generator
 ...
 *
 * apps/web/src/lib/locale.test.ts asserts this corpus's keys match
 * LANGUAGE_BCP47_MAP's keys exactly.
 */
