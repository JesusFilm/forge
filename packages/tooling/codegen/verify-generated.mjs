...
const files = [
  ...
  resolve("../../clients/kotlin-android/src/main/kotlin/com/forge/generated/ForgeApi.kt"),
];
...
for (const file of files) {
  ...
  if (!content.includes(stamp)) {
    throw new Error(`Generated file stamp missing: ${file}. Manual edits are not allowed.`);
  }
}
