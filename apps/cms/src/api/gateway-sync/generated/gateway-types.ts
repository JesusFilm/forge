...
export type MutationPlaylistCreateResult =
  | MutationPlaylistCreateSuccess
  | ZodError
...
export type MutationPlaylistDeleteResult =
  | MutationPlaylistDeleteSuccess
  | NotFoundError
...
export type MutationPlaylistItemAddResult =
  | MutationPlaylistItemAddSuccess
  | NotFoundError
...
export type MutationPlaylistItemAddWithVideoAndLanguageIdsResult =
  | MutationPlaylistItemAddWithVideoAndLanguageIdsSuccess
  | NotFoundError
...
export type MutationPlaylistItemRemoveResult =
  | MutationPlaylistItemRemoveSuccess
  | NotFoundError
...
export type MutationPlaylistItemsReorderResult =
  | MutationPlaylistItemsReorderSuccess
  | NotFoundError
...
export type MutationPlaylistUpdateResult =
  | MutationPlaylistUpdateSuccess
  | NotFoundError
  | ZodError
...
export type MutationShortLinkCreateResult =
...
export type MutationShortLinkDeleteResult =
...
export type MutationShortLinkDomainCreateResult =
...
export type MutationShortLinkDomainDeleteResult =
  | ForeignKeyConstraintError
  | MutationShortLinkDomainDeleteSuccess
  | NotFoundError
...
export type MutationShortLinkDomainUpdateResult =
  | MutationShortLinkDomainUpdateSuccess
  | NotFoundError
...
export type MutationShortLinkUpdateResult =
...
export type Query = {
  ...
  templateFamilyStatsBreakdown?: Maybe<
    Array<TemplateFamilyStatsBreakdownResponse>
  >
...
export type QueryGetMyGeneratedMuxSubtitleTrackResult =
  | Error
...
export type QueryShortLinkByPathResult =
  | NotFoundError
  | QueryShortLinkByPathSuccess

export type QueryShortLinkByPathSuccess = {
  data: ShortLink
}

export type QueryShortLinkDomainResult =
  | NotFoundError
  | QueryShortLinkDomainSuccess
...
export type QueryYoutubeClosedCaptionLanguagesResult =
  | Error
...
export type SyncCountriesQuery = {
  countries: Array<{
    ...
    languageHavingMediaCount: number
    continent: {
      id: string
...
export type SyncKeywordsQueryVariables = Exact<{ [key: string]: never }>
...
export type SyncVideoVariantsQuery = {
  videoVariants: Array<{
    ...
    videoId?: string | null
    language: { id: string }
    videoEdition: { id: string; name?: string | null }
    muxVideo?: {
      id: string
      assetId?: string | null
