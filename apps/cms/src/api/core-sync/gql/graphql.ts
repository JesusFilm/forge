/* eslint-disable */
/**
 * IMPORTANT: This file is generated by @graphql-codegen/client-preset.
 *
 * The codegen strips optional variable definitions ($where, $input) from the
 * DocumentNode AST objects. Apollo Client then serializes queries without these
 * parameters, breaking incremental sync filters. Search for "PATCHED" comments
 * below to see the manual fixes. If you re-run codegen, you must re-apply these
 * patches. See docs/solutions/cms/core-sync-production-vs-local-performance-gap.md
 */
  ...
  definitions: [
    {
      ...
      // PATCHED: codegen strips optional variableDefinitions — Apollo needs them
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              // PATCHED: codegen strips where argument
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
                value: {
  ...
  definitions: [
    {
      ...
      // PATCHED: codegen strips optional variableDefinitions
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            // PATCHED: codegen strips input argument
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        // PATCHED: codegen strips optional $input variable definition
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              // PATCHED: codegen strips optional input argument
              {
                kind: "Argument",
                name: { kind: "Name", value: "input" },
                value: {
        ...
        selections: [
          {
            ...
            // PATCHED: codegen had hardcoded { published: true } — needs to use $where variable
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        // PATCHED: codegen strips optional $where variable definition
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
        ...
        selections: [
          {
            ...
            arguments: [
              // PATCHED: codegen inlined the where value — needs to be a variable reference
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
                value: {
