// SYNC: mirrors apps/tv/src/lib/cardImage.ts. The one owner of "which image
// field wins" for card/poster art — the precedence and scan semantics live here,
// not in per-surface pickers (mobile had three divergent copies).
