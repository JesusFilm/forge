 ...
 * detent index. Listener registers once on [navigation] (mid-drag rotation
 * can't drop an event), bails on unchanged index (no render thrash), and is
 * derived not stored (tracks windowHeight without an extra effect).
 */
