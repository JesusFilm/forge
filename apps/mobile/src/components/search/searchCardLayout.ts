 ...
 * its LARGEST: SEARCH_CARD_TITLE_MAX_SCALE lifts lineHeight 18 to 20.7, so
 * 8 top + 2x20.7 = 49.4, plus 4 of breathing room, rounded up. Change both
 * together.
 */
export const SEARCH_CARD_TEXT_HEIGHT = 54
