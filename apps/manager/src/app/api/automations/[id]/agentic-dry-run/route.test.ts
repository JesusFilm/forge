...
function buildRequest(input: unknown = {}) {
  return new Request(
    "http://example.test/api/automations/automation-1/agentic-dry-run",
    {
      method: "POST",
      headers: {
        "content-type": "application/json",
        authorization: "Bearer test-manager-agentic-api-key",
      },
...
describe("POST /api/automations/[id]/agentic-dry-run", () => {
  beforeEach(() => {
