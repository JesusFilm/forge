      ...
      <SeriesHero
        ...
        overlay={
          ...
          <div
            ...
            className="absolute right-5 bottom-0 left-5 flex flex-col items-stretch gap-3 pb-5 max-[360px]:pb-2 md:right-16 md:left-16 md:pb-10 xl:right-24 xl:left-24"
          >
            <span
