...
const FIELD_BASE_CLASS = `group flex h-[52px] min-w-0 cursor-text items-center gap-3 rounded-[35px] px-6 py-3 text-start shadow-xl ${GLASS_OUTLINE_CLASS} transition-[top,opacity,background-color,color] duration-300 ease-out focus-visible:outline-2 focus-visible:outline-white/80 focus-visible:outline-offset-2`
    ...
    >
      ...
      {hasValue && onClear ? (
        <button
          ...
          className="-me-2 inline-flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-stone-500 transition hover:text-stone-950 focus-visible:outline-2 focus-visible:outline-stone-950/50 focus-visible:outline-offset-2"
        >
          <svg
