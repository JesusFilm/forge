...
describe("FloatingSearchProvider — watch playback chrome", () => {
  it("hides the floating search bar with the rest of the header chrome", () => {
    ...
    expect(searchButton?.className).toContain("left-[6rem]")
    expect(searchButton?.className).toContain("right-[6rem]")
    expect(searchButton?.className).toContain("w-auto")
    expect(searchButton?.className).toContain("max-w-none")
    expect(searchButton?.className).toContain("translate-x-0")
    expect(searchButton?.className).toContain("md:left-1/2")
    expect(searchButton?.className).toContain("md:right-auto")
    expect(searchButton?.className).toContain("md:w-[calc(100%-3rem)]")
    expect(searchButton?.className).toContain("md:max-w-[810px]")
    expect(searchButton?.className).toContain("md:-translate-x-1/2")
