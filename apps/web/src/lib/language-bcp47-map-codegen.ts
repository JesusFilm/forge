...
export function renderLanguageBcp47MapSource(
  ...
  const lines = [
    ...
    "//",
    "// The runtime route classifier and the watch content identity in",
    "// lib/content.ts also admit audio slugs from the live Watch route",
    "// manifest, so a stale copy of this file degrades <html lang> and UI",
    "// chrome for a new language — it must not 404 its URL or play English.",
    "",
