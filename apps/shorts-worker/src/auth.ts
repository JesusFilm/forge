...
// SHORTS_WORKER_API_KEYS must be a DISTINCT secret from CROP_WORKER_API_KEYS
// — a shared value would make one worker's bearer authorize the other
// (plan env notes).
export function validateBearer(
  authorizationHeader: string | string[] | undefined,
  {
    apiKeysCsv = env.SHORTS_WORKER_API_KEYS,
