...
export const supportResearchAgent = new Agent({
  ...
  instructions: [
    ...
    "Set validationTarget to url_availability only when the user specifically reports that an allowlisted Watch URL or page is unavailable. Use interactive_or_other for playback, controls, captions, language, account, device, intermittent, redirect-expectation, or other behavior. Use none when validation is not recommended.",
