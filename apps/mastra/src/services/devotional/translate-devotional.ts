...
const TRANSLATED_JSON_SCHEMA = {
  ...
  schema: {
    ...
    properties: {
      title: { type: "string", minLength: 1, maxLength: MAX_DEVOTIONAL_TEXT_LENGTH },
      reflection: { type: "string", minLength: 1, maxLength: MAX_DEVOTIONAL_TEXT_LENGTH },
      conclusion: { type: "string", minLength: 1, maxLength: MAX_DEVOTIONAL_TEXT_LENGTH },
      question: { type: "string", minLength: 1, maxLength: MAX_DEVOTIONAL_TEXT_LENGTH },
      prayer: { type: "string", minLength: 1, maxLength: MAX_DEVOTIONAL_TEXT_LENGTH },
    },
