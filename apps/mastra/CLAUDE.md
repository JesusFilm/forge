...
| `OPENROUTER_API_KEY`                      | OpenRouter key for the seeker agent's model (`openrouter/...`), locale-quality eval query generation, and offline compare judging. Required for the seeker agent and for compare mode. |
