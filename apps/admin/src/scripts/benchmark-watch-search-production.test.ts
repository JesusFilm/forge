...
describe("production Watch Search latency probe", () => {
  ...
  it("separates server and full round-trip percentiles", () => {
    expect(
      ...
      accepted: 2,
      degraded: 1,
      server: { p50Ms: 40, p95Ms: 80, p99Ms: 80 },
      roundTrip: { p50Ms: 100, p95Ms: 300, p99Ms: 300 },
      surfaceFirstSeen: {
        samples: 1,
        server: { p50Ms: 40, p95Ms: 40, p99Ms: 40 },
        roundTrip: { p50Ms: 100, p95Ms: 100, p99Ms: 100 },
      },
      repeat: {
        samples: 1,
        server: { p50Ms: 80, p95Ms: 80, p99Ms: 80 },
        roundTrip: { p50Ms: 300, p95Ms: 300, p99Ms: 300 },
      },
