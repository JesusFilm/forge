...
async function ensureTable() {
  ...
  `)
  // pgvector HNSW caps at 2000 dimensions. Skip the ANN index for
  // higher-dim models — KNN sequential scan over the few-thousand-row
  // candidate table is microseconds.
  if (OLLAMA_EMBEDDING_DIMENSIONS <= 2000) {
    await prisma.$executeRawUnsafe(`
