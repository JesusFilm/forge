...
export type ChatMessageDTO = {
  ...
  /**
   * Producer id (agent or workflow) for this assistant turn. Used by
   * the chat panel to decide whether to render the 👍/👎 rating
   * widget. `null` for historic rows persisted before migration
   * 0017 (those stay non-ratable by construction).
   */
