...
export type CandidateWatchSearchRankingRevision =
  | typeof WATCH_SEARCH_TITLE_AND_BRAND_RANKING_IMPLEMENTATION
  | typeof WATCH_SEARCH_CANONICAL_INTENT_RANKING_IMPLEMENTATION

export function isCandidateWatchSearchRankingRevision(
  value: string,
): value is CandidateWatchSearchRankingRevision {
  return (
    value === WATCH_SEARCH_TITLE_AND_BRAND_RANKING_IMPLEMENTATION ||
    value === WATCH_SEARCH_CANONICAL_INTENT_RANKING_IMPLEMENTATION
  )
}
