...
mediaCollection:
  {"t":"mediaCollection","variant":"grid","cardOrientation":"horizontal","title":"Watch the story","items":[{"videoId":"<cuid>","titleOverride":"Optional item title","labelOverride":"Optional eyebrow label"}]}
  - "variant" REQUIRED: "carousel" | "grid" | "collection" | "hero" | "player".
  - "cardOrientation" OPTIONAL: "horizontal" | "vertical". Use it when the user specifies the card shape.
