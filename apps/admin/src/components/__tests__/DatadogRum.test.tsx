...
describe("DatadogRum", () => {
  ...
  it("initializes RUM with Admin config when credentials are present", async () => {
  ...
  it("reports caught boundary errors to RUM", () => {
    const error = new Error("render failed")

    reportDatadogRumError(error, { boundary: "admin-dashboard" })
