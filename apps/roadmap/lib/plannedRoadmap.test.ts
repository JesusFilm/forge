...
describe("planned roadmap", () => {
  ...
  it("adds each year-end priority as its own four-week block", () => {
    ...
    expect(futureWork.map(({ title }) => title)).toEqual([
      "Explore China streaming",
      "Define Mobile + TV MVP",
      "Improve search quality",
      "Decompose components",
      "Present to Miheret",
      "Advance video agents",
      "Run experience generation",
      "Build service-improvement loops",
      "Expand language support",
      "Ship NextSteps",
      "Translate Core content",
      "Translate Bible quotations",
      "Add accounts + notifications",
      "Collect mission stories",
      "Clarify next-step actions",
      "Make search shareable",
      "Create verse video pages",
      "Generate video FAQs",
      "Operate SEO agent",
      "Operate support agent",
      "Operate translation agent",
    ])
    expect(futureWork.map(({ badge }) => badge)).toEqual([
      "Caleb",
      "Urim + Up",
      "Nisal",
      "Jaco + Jian Wei",
