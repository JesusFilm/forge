...
- **infra/aws:** `terraform init -backend-config=../backend-config/shared.hcl -backend-config=backend-config/stage.hcl -reconfigure` (or `-backend-config=backend-config/prod.hcl`)
