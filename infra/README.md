...
- `github/`: Forge repo config (Actions variables, repo settings, deployment environments); may expand to org management. Reads role ARNs and GitHub App auth from AWS prod state (remote state). State in same S3 bucket.
