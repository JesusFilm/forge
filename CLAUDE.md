...
- `apps/chat/` — Next.js chat UI for the `apps/mastra` Seeker agent; replies stream from Seeker behind the `SEEKER_CHAT_ENABLED` kill switch composed with the per-user LaunchDarkly seeker dogfood gate (feat-233), stub otherwise
